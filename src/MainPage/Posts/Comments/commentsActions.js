...
export function fetchComment(commentId) {
  return function(dispatch) {
    ...
    axios.get(`${API_URL}/comments/${commentId}`, { headers: headers })
      .then((response) => {
...
export function createComment(commentToSubmit, callback) {
  return function(dispatch) {
    axios.post(`${API_URL}/comments`, commentToSubmit, { headers: headers })
      .then((response) => {
...
export function editComment(commentToEdit, callback) {
  return function(dispatch) {
    axios.put(`${API_URL}/comments/${commentToEdit.id}`, commentToEdit, { headers: headers })
      .then((response) => {
...
export function deleteComment(commentId, callback) {
  return function(dispatch) {
    axios.delete(`${API_URL}/comments/${commentId}`, { headers: headers })
      .then((response) => {
